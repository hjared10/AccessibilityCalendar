...
!function() {
    ...
    window.dhtmlxAjax = {
        get: function(t, e) {
            ...
            return i.async = arguments.length < 3,
            i.waitCall = e,
            i.loadXML(t),
            i
        },
        post: function(t, e, i) {
            ...
            return n.async = arguments.length < 4,
            n.waitCall = i,
            n.loadXML(t, !0, e),
            n
        },
    ...
    dtmlXMLLoaderObject.prototype.waitLoadFunction = function(t) {
        ...
        return this.check = function() {
            if (t && t.onloadAction && (!t.xmlDoc.readyState || 4 == t.xmlDoc.readyState)) {
                ...
                t.waitCall && (t.waitCall.call(this, t),
                t.waitCall = null)
            }
        }
        ,
    ...
    dtmlXMLLoaderObject.prototype.getXMLTopNode = function(t, e) {
        ...
        return dhtmlxError.throwError("LoadXML", "Incorrect XML", [e || this.xmlDoc, this.mainObject]),
    ...
    dtmlXMLLoaderObject.prototype.loadXMLString = function(t, e) {
        ...
        e || (this.onloadAction && this.onloadAction(this.mainObject, null, null, null, this),
    ...
    dtmlXMLLoaderObject.prototype.loadXML = function(t, e, i, n) {
        ...
        "string" == typeof e ? this.xmlDoc.open(e, t, this.async) : this.xmlDoc.open(e ? "POST" : "GET", t, this.async),
        n ? (this.xmlDoc.setRequestHeader("User-Agent", "dhtmlxRPC v0.1 (" + navigator.userAgent + ")"),
        this.xmlDoc.setRequestHeader("Content-type", "text/xml")) : e && this.xmlDoc.setRequestHeader("Content-type", "application/x-www-form-urlencoded"),
    ...
    dtmlXMLLoaderObject.prototype.xmlNodeToJSON = function(t) {
        ...
        for (var i = 0; i < t.childNodes.length; i++) {
            ...
            n && (e[n] || (e[n] = []),
            e[n].push(this.xmlNodeToJSON(t.childNodes[i])))
        }
        return e
    }
    ,
    ...
    dhtmlDragAndDropObject.prototype.addDraggableItem = function(t, e) {
        t.onmousedown = this.preCreateDragCopy,
        t.dragStarter = e,
        this.addDragLanding(t, e)
    }
    ,
    ...
    dhtmlDragAndDropObject.prototype.preCreateDragCopy = function(t) {
        if (!t && !window.event || 2 != (t || event).button)
            ...
            !1) : (window.dhtmlDragAndDrop.dragNode && window.dhtmlDragAndDrop.stopDrag(t),
    ...
    dhtmlDragAndDropObject.prototype.callDrag = function(t) {
        ...
        if (!((new Date).valueOf() - e.downtime < 100)) {
            if (!e.dragNode) {
                if (!e.waitDrag)
                    return e.stopDrag(t, !0);
                if (e.dragNode = e.dragStartObject._createDragNode(e.dragStartNode, t),
                !e.dragNode)
                    return e.stopDrag();
            ...
            if (e.dragNode.parentNode != window.document.body && e.gldragNode) {
                var i = e.gldragNode;
                e.gldragNode.old && (i = e.gldragNode.old),
                ...
                _isIE) {
                    ...
                    a.innerHTML = e.dragNode.outerHTML,
                    e.dragNode = a.childNodes[0]
                } else
                    e.dragNode = e.dragNode.cloneNode(!0);
                e.dragNode.pWindow = window,
                e.gldragNode.old = e.dragNode,
                document.body.appendChild(e.dragNode),
                n.dhtmlDragAndDrop.dragNode = e.dragNode
            }
            e.dragNode.style.left = t.clientX + 15 + (e.fx ? -1 * e.fx : 0) + (document.body.scrollLeft || document.documentElement.scrollLeft) + "px",
            e.dragNode.style.top = t.clientY + 3 + (e.fy ? -1 * e.fy : 0) + (document.body.scrollTop || document.documentElement.scrollTop) + "px";
            var r;
    ...
    dhtmlDragAndDropObject.prototype.checkLanding = function(t, e) {
        t && t.dragLanding ? (this.lastLanding && this.lastLanding.dragLanding._dragOut(this.lastLanding),
        this.lastLanding = t,
        this.lastLanding = this.lastLanding.dragLanding._dragIn(this.lastLanding, this.dragStartNode, e.clientX, e.clientY, e),
        this.lastLanding_scr = _isIE ? e.srcElement : e.target) : t && "BODY" != t.tagName ? this.checkLanding(t.parentNode, e) : (this.lastLanding && this.lastLanding.dragLanding._dragOut(this.lastLanding, e.clientX, e.clientY, e),
        this.lastLanding = 0,
    ...
    dtmlXMLLoaderObject.prototype.doXPath = function(t, e, i, n) {
        if (_isKHTML || !_isIE && !window.XPathResult)
            return this.doXPathOpera(t, e);
        if (_isIE)
            return e || (e = this.xmlDoc.nodeName ? this.xmlDoc : this.xmlDoc.responseXML),
        ...
        e || dhtmlxError.throwError("LoadXML", "Incorrect XML", [e || this.xmlDoc, this.mainObject]),
        -1 != e.nodeName.indexOf("document") ? a = e : (a = e,
        e = e.ownerDocument);
    ...
    dtmlXMLLoaderObject.prototype.doXPathOpera = function(t, e) {
        ...
        return -1 != i[a - 1].indexOf("[") && (n = this._filterXPath(n, i[a - 1])),
        n
    }
    ,
    ...
    dtmlXMLLoaderObject.prototype.doXSLTransToObject = function(t, e) {
        ...
        if (_isIE) {
            ...
            this.XSLProcessor.importStylesheet(t)),
    ...
    window.dhtmlxEventable = function(obj) {
        ...
        obj.detachAllEvents = function() {
            for (var t in this)
                0 === t.indexOf("ev_") && (this.detachEvent(t),
                this[t] = null)
        }
        ,
        obj = null
    ...
    function() {
            ...
            if (c) {
                ...
                if (dhtmlx.message.keyboard) {
                    if (13 == i || 32 == i) {
                        ...
                        scheduler._getClassName(a).indexOf("dhtmlx_popup_button") > -1 && a.click ? a.click() : (t(c, !0),
                        n = !0)
                    }
                    27 == i && (t(c, !1),
                    n = !0)
        ...
        function i(t) {
            i.cover || (i.cover = document.createElement("div"),
            i.cover.onkeydown = e,
        ...
        function a(t) {
            ...
            return e.innerHTML = "<div>" + t.text + "</div>",
            ...
            "bottom" == u.position && u.area.firstChild ? u.area.insertBefore(e, u.area.firstChild) : u.area.appendChild(e),
        ...
        function r(e, i, a) {
            ...
            r.className = " dhtmlx_modal_box dhtmlx-" + e.type,
            r.setAttribute("dhxbox", 1);
            var s = scheduler.uid();
            scheduler._waiAria.messageModalAttr(r, s);
            var o = ""
              , d = !1;
            if (e.width && (r.style.width = e.width),
            e.height && (r.style.height = e.height),
            e.title && (o += '<div class="dhtmlx_popup_title" id="' + s + '">' + e.title + "</div>",
            d = !0),
            o += '<div class="dhtmlx_popup_text" ' + (d ? "" : ' id="' + s + '" ') + "><span>" + (e.content ? "" : e.text) + '</span></div><div  class="dhtmlx_popup_controls">',
            i) {
            ...
            if (e.buttons)
                for (var h = 0; h < e.buttons.length; h++)
                    o += n(e.buttons[h], h);
            if (o += "</div>",
            r.innerHTML = o,
            e.content) {
        ...
        function s(t, n, a) {
            ...
            return "top" == t.position ? s.style.top = "-3px" : s.style.top = d + "px",
            s.style.left = o + "px",
            s.onkeydown = e,
        ...
        var u = dhtmlx.message = function(t, e, i, n) {
            switch (t = h.apply(this, arguments),
            t.type = t.type || "info",
            t.type.split("-")[0]) {
            case "alert":
                return o(t);
    ...
    dataProcessor.prototype = {
        setTransactionMode: function(t, e) {
            ...
            void 0 !== t.payload && (this._payload = t.payload)) : (this._tMode = t,
            this._tSend = e),
        ...
        setUpdated: function(t, e, i) {
            if (!this._silent_mode) {
                ...
                a && "updated" == i && (i = a),
                e ? (this.set_invalid(t, !1),
                this.updatedRows[n] = t,
                this.obj.setUserData(t, this.action_param, i),
                this._in_progress[t] && (this._in_progress[t] = "wait")) : this.is_invalid(t) || (this.updatedRows.splice(n, 1),
        ...
        markRow: function(t, e, i) {
            ...
            e = !0),
            this.callEvent("onRowMark", [t, e, i, a]) && (n = this.styles[e ? i : "clear"] + n,
        ...
        serialize: function(t, e) {
            ...
            var i = []
              , n = [];
            for (var a in t)
                t.hasOwnProperty(a) && (i.push(this.serialize_one(t[a], a + this.post_delim)),
                n.push(a));
            return i.push("ids=" + this.escape(n.join(","))),
            (scheduler.security_key || dhtmlx.security_key) && i.push("dhx_security=" + (scheduler.security_key || dhtmlx.security_key)),
            i.join("&")
        },
            ...
            if (t) {
                ...
                if ("GET" == this._tMode)
                    ...
                    var _ = this.getState(e)
                      ...
                      , d = ""
                      , c = "post";
                    "inserted" == _ ? d = this.serialize(t, e) : "deleted" == _ ? (c = "DELETE",
                    h = h + ("/" == h.slice(-1) ? "" : "/") + e) : (c = "PUT",
        ...
        _getAllData: function(t) {
            for (var e = {}, i = !1, n = 0; n < this.updatedRows.length; n++) {
                ...
                if (!this._in_progress[a] && !this.is_invalid(a)) {
                    ...
                    this.callEvent("onBeforeUpdate", [a, this.getState(a), r]) && (e[a] = r,
                    i = !0,
        ...
        afterUpdateCallback: function(t, e, i, n) {
            ...
            "wait" != this._in_progress[a] ? (r && this.obj.setUserData(t, this.action_param, ""),
        ...
        _errorResponse: function(t, e) {
            return this.obj && this.obj.callEvent && this.obj.callEvent("onSaveError", [e, t.xmlDoc]),
            this.cleanUpdate(e)
        },
        afterUpdate: function(t, e, i) {
            var n = this.obj.$ajax;
            if (200 !== e.xmlDoc.status)
                return void this._errorResponse(e, i);
            if (window.JSON) {
                var a;
                try {
                ...
                if (a) {
                    var r = a.action || this.getState(i) || "updated"
                      , s = a.sid || i[0]
                      , o = a.tid || i[0];
                    return t.afterUpdateCallback(s, o, r, a),
                    void t.finalizeUpdate()
                }
            }
            var d = n.xmltop("data", e.xmlDoc);
            if (!d)
                return this._errorResponse(e, i);
    ...
    Scheduler.getSchedulerInstance = function() {
        ...
        function e(t) {
            ...
            if (t.view)
                ...
                t.rows ? e = p.rows_container : t.cols && (e = p.row);
            return e
        }
        function i(t) {
            var i = e(t);
            if (i) {
                var n = i(t);
                if (t.css && n.classList.add(t.css),
                t.width) {
                    var a = t.width;
                    a === 1 * a && (a += "px"),
                    n.style.width = a
                ...
                if (t.click && n.addEventListener("click", t.click),
        ...
        function n(t) {
            ...
            t.view || t.rows || t.cols || (t.view = "button"),
            t
        }
        function a(t) {
        ...
        function s(t) {
            var e = ["day", "week", "month"]
              ...
              , n = ["prev", "today", "next"];
            if (t.matrix)
                for (var a in t.matrix)
                    e.push(a);
            if (t._props)
                for (var a in t._props)
                    e.push(a);
            if (t._grid && t._grid.names)
                for (var a in t._grid.names)
                    e.push(a);
        ...
        function c() {
            if (void 0 === A) {
                ...
                t.style.left = "-9999px",
                t.style.top = "-9999px",
                t.innerHTML = "<div class='dhx_cal_container'><div class='dhx_cal_scale_placeholder'></div><div>",
        ...
        function u() {
            ...
            t.style.left = "-9999px",
            t.style.top = "-9999px",
            t.innerHTML = "<div class='dhx_cal_container'><div class='dhx_cal_data'><div class='dhx_cal_event'><div class='dhx_body'></div></div><div>",
            document.body.appendChild(t);
            var e = window.getComputedStyle(t.querySelector(".dhx_body"))
              , i = e.getPropertyValue("box-sizing");
            document.body.removeChild(t),
            (k = !("border-box" !== i)) || setTimeout(function() {
                k = void 0
            }, 1e3)
        }
        function f() {
        ...
        var p = {
            ...
            view: function(e) {
                var i = t("dhx_cal_tab");
                return i.setAttribute("name", e.view + "_tab"),
                i.setAttribute("data-viewname", e.view),
                g.config.fix_tab_position && (e.$firstTab ? i.classList.add("dhx_cal_tab_first") : e.$lastTab ? i.classList.add("dhx_cal_tab_last") : "week" !== e.view && i.classList.add("dhx_cal_tab_standalone")),
                i
            },
            date: function() {
        ...
        g._init_once = function() {
            ...
            var n = e();
            g.event(window, "resize", function() {
                t(g._obj) && (window.clearTimeout(g._resize_timer),
                g._resize_timer = window.setTimeout(function() {
                    var a = e();
                    if (!i(n, a)) {
                        if (!t(g._obj))
                            return;
                        g.callEvent("onSchedulerResize", []) && (g.updateView(),
                        g.callEvent("onAfterSchedulerResize", []))
                    }
                    n = a
                }, 100))
            }),
        ...
        var y = {
            ...
            header: {
                render: function(t) {
                    var e = document.createElement("div");
                    return e.className = "dhx_cal_header",
                    e
                }
            },
            dataArea: {
                render: function(t) {
                    var e = document.createElement("div");
                    return e.className = "dhx_cal_data",
                    e
                }
            },
            html_element: {
        ...
        g.init = function(t, e, i) {
            if (e = e || g._currentDate(),
            i = i || "week",
            this._obj && this.unset_actions(),
            this._obj = "string" == typeof t ? document.getElementById(t) : t,
            this.$container = this._obj,
            !this.$container.offsetHeight && this.$container.offsetWidth && "100%" === this.$container.style.height && window.console.error(g._commonErrorMessages.collapsedContainer(), this.$container),
            this.config.wai_aria_attributes && this.config.wai_aria_application_role && this.$container.setAttribute("role", "application"),
            this.config.header || r(this.$container) || (this.config.header = s(this),
        ...
        g.set_sizes = function() {
            ...
            g._is_material_skin() ? (a || (a = document.createElement("div"),
            a.className = "dhx_cal_scale_placeholder",
            this.$container.insertBefore(a, this._els.dhx_cal_header[0])),
            a.style.display = "block",
            this.set_xy(a, t, this.xy.scale_height + 1, 0, this.xy.nav_height + (this._quirks ? -1 : 1))) : a && a.parentNode.removeChild(a),
            this._lightbox && (g.$container.offsetWidth < 1200 || this._setLbPosition(document.querySelector(".dhx_cal_light"))),
            this.set_xy(this._els.dhx_cal_navline[0], t, this.xy.nav_height, 0, 0),
            this.set_xy(this._els.dhx_cal_header[0], t - i, this.xy.scale_height, n, this.xy.nav_height + (this._quirks ? -1 : 1));
        ...
        g.get_elements = function() {
            for (var t = this._obj.getElementsByTagName("DIV"), e = 0; e < t.length; e++) {
                ...
                i && (i = i.split(" ")[0]),
                this._els[i] || (this._els[i] = []),
                this._els[i].push(t[e]);
                var a = g.locale.labels[n || i];
                "string" != typeof a && n && !t[e].innerHTML && (a = n.split("_")[0]),
                a && (this._waiAria.labelAttr(t[e], a),
                t[e].innerHTML = a)
            }
        }
        ,
        g.unset_actions = function() {
            for (var t in this._els)
                if (this._click[t])
                    for (var e = 0; e < this._els[t].length; e++)
        ...
        ,
        g.select = function(t) {
            this._select_id != t && (g._close_not_saved(),
            this.editStop(!1),
            this.unselect(),
            this._select_id = t,
            this.updateEvent(t))
        ...
        g._click = {
            dhx_cal_data: function(t) {
                ...
                if (t = t || event,
                i) {
                    if (!g.callEvent("onClick", [i, t]) || g.config.readonly)
                        return
                } else
                    g.callEvent("onEmptyClick", [g.getActionData(t).date, t]);
                if (i && g.config.select) {
                    ...
                    g._close_not_saved(),
                    (new Date).valueOf() - (g._new_event || 0) > 500 && g.unselect()
            },
            ...
            dhx_cal_next_button: function(t, e) {
                ...
                g.config.rtl && (e = -e,
                i = -i),
                g.setCurrentView(g.date.add(g.date[g._mode + "_start"](new Date(g._date)), e || i, g._mode))
            },
        ...
        g.addEventNow = function(t, e, i) {
            ...
            return this.callEvent("onEventCreated", [this._drag_id, i]),
            this._loading = !1,
            this._drag_event = {},
            this._on_mouse_up(i),
            d
        ...
        g._on_dbl_click = function(t, e) {
            ...
            !this.config.readonly) {
                ...
                case "dhx_cal_event_clear":
                    ...
                    if (!this.callEvent("onDblClick", [n, t]))
                        return;
                ...
                default:
                    ...
                    if (a)
                        a.call(this, t);
                    else if (e.parentNode && e != this)
                        return g._on_dbl_click(t, e.parentNode)
                }
            }
        }
        ,
        g._get_column_index = function(t) {
            ...
            if (this._cols) {
                for (var i = 0, n = 0; i + this._cols[n] < t && n < this._cols.length; )
                    i += this._cols[n],
                    n++;
                if (e = n + (this._cols[n] ? (t - i) / this._cols[n] : 0),
                this._ignores && e >= this._cols.length)
                    for (; e >= 1 && this._ignores[Math.floor(e)]; )
                        e--
            }
            return e
        }
        ...
        g._week_indexes_from_pos = function(t) {
            if (this._cols) {
                ...
                t.y = Math.max(0, Math.ceil(60 * t.y / (this.config.time_step * this.config.hour_size_px)) - 1) + this.config.first_hour * (60 / this.config.time_step),
                t
            }
            return t
        }
        ...
        g._mouse_coords = function(t) {
            ...
            e.y -= this.$domHelpers.getAbsoluteTop(this._obj) + this.xy.nav_height + (this._dy_shift || 0) + this.xy.scale_height - this._els.dhx_cal_data[0].scrollTop,
            e.ev = t;
            ...
            if (a)
                ...
                (g._drag_mode || "month" == this._mode) && (e.y = 24 * (Math.max(0, Math.ceil(r) - 1) + 7 * Math.max(0, s - 1)) * 60 / this.config.time_step),
                "move" == this._drag_mode && g._ignores_detected && g.config.preserve_length && (e._ignores = !0,
                ...
                e = this._week_indexes_from_pos(e);
        ...
        g._correct_drag_start_date = function(t) {
            ...
            t = new Date(t);
            var i = 1;
            return (e._start_correction || e._end_correction) && (i = 60 * (e.last_hour || 0) - (60 * t.getHours() + t.getMinutes()) || 1),
            1 * t + (g._get_fictional_event_length(t, i, e) - i)
        }
        ,
        g._correct_drag_end_date = function(t, e) {
            var i;
            g.matrix && (i = g.matrix[g._mode]),
            i = i || {
                x_step: 1,
                x_unit: "day"
            };
            ...
            if (this._drag_mode) {
                ...
                if (this._is_pos_changed(this._drag_pos, e)) {
                    ...
                    !this._drag_mode)
                        return;
                    var a = null;
                    if (this._drag_pos && !this._drag_pos.has_moved && (a = this._drag_pos,
                    a.has_moved = !0),
                    this._drag_pos = e,
                    ...
                    "create" == this._drag_mode) {
                        ...
                        !this._drag_start) {
                            return this.callEvent("onBeforeEventCreated", [t, this._drag_id]) ? (this._loading = !1,
                            void (this._drag_start = i)) : void (this._loading = !1)
                        }
                        n = i,
                        this._drag_start;
                        var r = new Date(this._drag_start)
                          , s = new Date(n);
                        "day" != this._mode && "week" != this._mode || r.getHours() != s.getHours() || r.getMinutes() != s.getMinutes() || (s = new Date(this._drag_start + 1e3)),
                    ...
                    if (g.matrix && (o = g.matrix[g._mode]),
                    o = o || {
                        x_step: 1,
                        x_unit: "day"
                    },
                    "move" == this._drag_mode)
                        ...
                        !this._table_view && this._dragEventBody && void 0 === this._drag_event._move_event_shift && (this._drag_event._move_event_shift = i - l.start_date),
                        this._drag_event._move_event_shift && (i -= this._drag_event._move_event_shift),
                        i = this._correct_shift(i),
                        e._ignores && this.config.preserve_length && this._table_view ? (i = g._correct_drag_start_date(i),
                        n = g._correct_drag_end_date(i, this._drag_event._event_length)) : n = l.end_date.valueOf() - (l.start_date.valueOf() - i);
                    else {
                        if (i = l.start_date.valueOf(),
                        n = l.end_date.valueOf(),
                        this._table_view) {
                            var _ = this._min_date.valueOf() + e.y * this.config.time_step * 6e4 + (e.custom ? 0 : 864e5);
                            if ("month" == this._mode)
                                if (_ = this._correct_shift(_, !1),
                                ...
                                this.config.preserve_length ? e.resize_from_start ? i = g._correct_drag_start_date(_) : n = g._correct_drag_end_date(_, 0) : e.resize_from_start ? i = _ : n = _
                        } else {
                    ...
                    if ("move" == this._drag_mode && g.config.limit_drag_out && (+E < +g._min_date || +n > +g._max_date)) {
                        if (+l.start_date < +g._min_date || +l.end_date > +g._max_date)
                            E = new Date(l.start_date),
                            n = new Date(l.end_date);
                        else {
                            var A = n - E;
                            +E < +g._min_date ? (E = new Date(g._min_date),
                            e._ignores && this.config.preserve_length && this._table_view ? (E = new Date(g._correct_drag_start_date(E)),
                            o._start_correction && (E = new Date(E.valueOf() + o._start_correction)),
                            n = new Date(1 * E + this._get_fictional_event_length(E, this._drag_event._event_length, o))) : n = new Date(+E + A)) : (n = new Date(g._max_date),
                            e._ignores && this.config.preserve_length && this._table_view ? (o._end_correction && (n = new Date(n.valueOf() - o._end_correction)),
                            n = new Date(1 * n - this._get_fictional_event_length(n, 0, o, !0)),
                            E = new Date(1 * n - this._get_fictional_event_length(n, this._drag_event._event_length, o, !0)),
                            this._ignores_detected && (E = g.date.add(E, o.x_step, o.x_unit),
                            n = new Date(1 * n - this._get_fictional_event_length(n, 0, o, !0)),
                            n = g.date.add(n, o.x_step, o.x_unit))) : E = new Date(+n - A))
                        }
                        var D = new Date(n - 1)
                    }
        ...
        g._on_mouse_down = function(t, e) {
            if (2 != t.button && !this.config.readonly && !this._drag_mode) {
                ...
                var i = g._getClassName(e).split(" ")[0];
                switch (this.config.drag_event_body && "dhx_body" == i && e.parentNode && -1 === e.parentNode.className.indexOf("dhx_cal_select_menu") && (i = "dhx_event_move",
                ...
                case "":
                    ...
                    break;
                default:
                    if ((!g.checkEvent("onMouseDown") || g.callEvent("onMouseDown", [i, t])) && e.parentNode && e != this && "dhx_body" != i)
                        return g._on_mouse_down(t, e.parentNode);
                    ...
                    if (n && (this._drag_event._dhx_changed || !this._drag_event.start_date || a.start_date.valueOf() != this._drag_event.start_date.valueOf() || a.end_date.valueOf() != this._drag_event.end_date.valueOf())) {
                        ...
                        if (this.callEvent("onBeforeEventChanged", [a, t, r, this._drag_event]))
                            ...
                            r && this.config.edit_on_create) {
                                ...
                                this._table_view || this.config.details_on_create || !this.config.select || !this.isOneDayEvent(this.getEvent(e)))
                                    return g.callEvent("onDragEnd", [e, i, t]),
                                    this.showLightbox(e);
                                this._drag_pos = !0,
                                this._select_id = this._edit_id = e
                            } else
                                this._new_event || this.callEvent(r ? "onEventAdded" : "onEventChanged", [e, this.getEvent(e)]);
                        else
        ...
        g._set_aria_buttons_attrs = function() {
            for (var t = ["dhx_cal_next_button", "dhx_cal_prev_button", "dhx_cal_tab", "dhx_cal_today_button"], e = 0; e < t.length; e++)
                for (var i = this._els[t[e]], n = 0; i && n < i.length; n++) {
                    ...
                    "dhx_cal_next_button" == t[e] ? r = this.locale.labels.next : "dhx_cal_prev_button" == t[e] && (r = this.locale.labels.prev),
        ...
        g.updateView = function(t, e) {
            ...
            var s, o = "dhx_multi_day", d = !(this._mode != e || !this.config.preserve_scroll) && this._els[i][0].scrollTop;
            this._els[o] && this._els[o][0] && (s = this._els[o][0].scrollTop),
            this[this._mode + "_view"] && e && this._mode != e && this[this._mode + "_view"](!1),
            this._close_not_saved(),
            this._els[o] && (this._els[o][0].parentNode.removeChild(this._els[o][0]),
            this._els[o] = null),
            this._mode = e,
            this._date = t,
            ...
            if (l)
                for (var _ = 0; _ < l.length; _++) {
                    var h = l[_];
                    h.getAttribute("name") == this._mode + "_tab" ? (h.classList.add("active"),
                    this._waiAria.headerToggleState(h, !0)) : (h.classList.remove("active"),
                    this._waiAria.headerToggleState(h, !1))
                }
        ...
        g.setCurrentView = function(t, e) {
            this.callEvent("onBeforeViewChange", [this._mode, this._date, e || this._mode, t || this._date]) && (this.updateView(t, e),
        ...
        g._render_x_header = function(t, e, i, n, a) {
            ...
            "month" == this._mode && 0 === t && this.config.left_border && (r.className += " dhx_scale_bar_border",
            e += 1),
            this.set_xy(r, s, this.xy.scale_height - 2, e, a);
            var o = this.templates[this._mode + "_scale_date"](i, this._mode);
            r.innerHTML = o,
            this._waiAria.dayHeaderAttr(r, o),
            n.appendChild(r)
        }
        ,
        ...
        g._calc_scale_sizes = function(t, e, i) {
            ...
            for (var s = r - this._ignores_detected, o = 0; o < r; o++)
                this._ignores[o] ? (this._cols[o] = 0,
                s++) : this._cols[o] = Math.floor(a / (s - o)),
                a -= this._cols[o],
                this._colsS[o] = (this._cols[o - 1] || 0) + (this._colsS[o - 1] || (this._table_view ? 0 : (n ? this.xy.scroll_width : this.xy.scale_width) + 2));
        ...
        g._render_scales = function(t, e) {
            ...
            t.innerHTML = "";
            for (var l = 0; l < o; l++) {
                if (this._ignores[l] || this._render_x_header(l, d, s, t),
                !this._table_view) {
                ...
                d += this._cols[l],
                s = this.date.add(s, 1, "day"),
                s = this.date.day_start(s)
            }
        }
        ,
        ...
        g._reset_scale = function() {
            if (this.templates[this._mode + "_date"]) {
                ...
                a = r = this._table_view ? g.date.week_start(s) : s,
                this._min_date = a;
                var d = this.templates[this._mode + "_date"](s, o, this._mode)
                  , l = this._getNavDateElement();
                if (l && (l.innerHTML = d,
                this._waiAria.navBarDateAttr(l, d)),
                this._max_date = o,
                g._render_scales(t, e),
                this._table_view)
                    this._reset_month_scale(e, s, r);
                else if (this._reset_hours_scale(e, s, r),
                i.multi_day) {
                    var _ = "dhx_multi_day";
                    this._els[_] && (this._els[_][0].parentNode.removeChild(this._els[_][0]),
                    this._els[_] = null);
        ...
        g._reset_hours_scale = function(t, e, i) {
            ...
            for (var a = new Date(1980,1,1,this.config.first_hour,0,0), r = 1 * this.config.first_hour; r < this.config.last_hour; r++) {
                ...
                s.className = "dhx_scale_hour",
                s.style.height = this.config.hour_size_px + "px";
        ...
        g._render_month_scale = function(t, e, i, n) {
            function a(t) {
                ...
                return void 0 !== g._colsS.heights[t + 1] && (e = g._colsS.heights[t + 1] - (g._colsS.heights[t] || 0)),
                e
            }
            ...
            for (var d = [], l = 0; l <= 7; l++) {
                ...
                0 === l && this.config.left_border && (_ -= 1),
                d[l] = _ + "px"
            }
            var h = 0
            ...
            for (var f = [], l = 0; l < n; l++) {
                ...
                for (var m = Math.max(a(l) - g.xy.month_head_height, 0), p = 0; p < 7; p++) {
                    ...
                    var y = "dhx_month_body"
                      , w = "dhx_month_head";
                    if (0 === p && this.config.left_border && (y += " dhx_month_body_border",
                    ...
                    this._ignores_detected && this._ignores[p])
                        ...
                        D.className = w,
                        D.innerHTML = this.templates.month_day(i),
                        x.appendChild(D);
                        var E = document.createElement("div");
                        E.className = y,
                        E.style.height = m + "px",
        ...
        g._reset_month_scale = function(t, e, i, n) {
            ...
            return this._colsS.height = s + this.xy.month_head_height,
            this._colsS.heights = [],
            g._render_month_scale(t, e, i, n)
        }
        ,
        g.getView = function(t) {
            return t || (t = g.getState().mode),
        ...
        g._lame_clone = function(t, e) {
            ...
            if (t && "object" == typeof t) {
                for (a = {},
                n = [Array, Date, Number, String, Boolean],
                i = 0; i < n.length; i++)
        ...
        g._focus = function(t, e) {
            if (t && t.focus)
                if (this._mobile)
                    ...
                    try {
                        e && t.select && t.offsetWidth && t.select(),
                        t.focus()
                    } catch (t) {}
        }
        ,
        g._get_real_event_length = function(t, e, i) {
            ...
            i.render ? (o = this._get_date_index(i, t),
            n = this._get_date_index(i, e)) : n = Math.round(a / 60 / 60 / 1e3 / 24);
            for (var d = !0; o < n; ) {
                var l = g.date.add(e, -i.x_step, i.x_unit);
                s && s(e) && (!d || d && s(l)) ? a -= e - l : (d = !1,
                a -= r),
                e = l,
                n--
            }
        ...
        g._get_fictional_event_length = function(t, e, i, n) {
            ...
            l = this._get_date_index(i, _)) : l = Math.round(e / 60 / 60 / 1e3 / 24); c * r <= l * r; ) {
        ...
        function() {
            function t(t) {
                ...
                if (window.getComputedStyle) {
                    ...
                    t.currentStyle && (e = t.currentStyle.display,
                    i = t.currentStyle.visibility);
                var a = !1
                  , r = g._locate_css({
                    target: t
                }, "dhx_form_repeat", !1);
        ...
        if (Element.prototype.closest)
            ...
            w = function(t, e) {
                ...
                } while (null !== i && 1 === i.nodeType);return null
            }
        }
        g.$env = {
        ...
        g.$ajax = {
            ...
            parse: function(t) {
                ...
                window.DOMParser && !g.$env.isIE ? e = (new window.DOMParser).parseFromString(t, "text/xml") : window.ActiveXObject !== window.undefined && (e = new window.ActiveXObject("Microsoft.XMLDOM"),
                e.async = "false",
                e.loadXML(t)),
                e
            },
            xmltop: function(t, e, i) {
                ...
                return -1 !== i && this._obj.callEvent("onLoadXMLError", ["Incorrect XML", arguments[1], i]),
                document.createElement("DIV")
            },
            xpath: function(t, e) {
                if (e.nodeName || (e = e.responseXML || e),
                g.$env.isIE)
            ...
            postLong: function(t, e, i) {
                2 != arguments.length || "function" != typeof e && (window[e],
                0) || (i = e,
                e = ""),
                this._call("POST", t, e, !0, i, {
                    url: t,
            ...
            _call: function(t, e, i, n, a, r, s) {
                ...
                if (n && (d.onreadystatechange = function() {
                    if (4 == d.readyState || l && 3 == d.readyState) {
                        if ((200 != d.status || "" === d.responseText) && !o.callEvent("onAjaxError", [d]))
                            return;
                        window.setTimeout(function() {
                ...
                "GET" != t || this.cache || (e += (e.indexOf("?") >= 0 ? "&" : "?") + "dhxr" + (new Date).getTime() + "=1"),
                d.open(t, e, n),
                s)
                    for (var _ in s)
                        d.setRequestHeader(_, s[_]);
                else
                    "POST" == t.toUpperCase() || "PUT" == t || "DELETE" == t ? d.setRequestHeader("Content-Type", "application/x-www-form-urlencoded") : "GET" == t && (i = null);
                if (d.setRequestHeader("X-Requested-With", "XMLHttpRequest"),
                d.send(i),
                !n)
                    return {
                        xmlDoc: d,
        ...
        g.date = {
            ...
            week_start: function(t) {
                var e = t.getDay();
                return g.config.start_on_monday && (0 === e ? e = 6 : e--),
            ...
            _add_days: function(t, e) {
                ...
                return e >= 0 && !t.getHours() && i.getHours() && (i.getDate() < t.getDate() || i.getMonth() < t.getMonth() || i.getFullYear() < t.getFullYear()) && i.setTime(i.getTime() + 36e5 * (24 - i.getHours())),
                i
            },
            add: function(t, e, i) {
        ...
        g.deleteEvent = function(t, e) {
            ...
            (e || this.callEvent("onBeforeEventDelete", [t, i]) && this.callEvent("onConfirmedBeforeEventDelete", [t, i])) && (i && (this._select_id = null,
            delete this._events[t],
            this.event_updated(i),
            this._drag_id == i.id && (this._drag_id = null,
            this._drag_mode = null,
            this._drag_pos = null)),
        ...
        function() {
            for (var t = ["text", "Text", "start_date", "StartDate", "end_date", "EndDate"], e = function(t) {
                ...
                g["getEvent" + t[n + 1]] = e(t[n]),
                g["setEvent" + t[n + 1]] = i(t[n])
        }(),
        ...
        g._render_month_link = function(t) {
            for (var e = this._rendered_location, i = this._lame_clone(t), n = t._sday; n < t._eday; n++) {
                ...
                var a = g.date
                  , r = g._min_date;
                r = a.add(r, i._sweek, "week"),
                r = a.add(r, i._sday, "day");
        ...
        g._recalculate_timed = function(t) {
            if (t) {
                var e;
                e = "object" != typeof t ? this._events[t] : t,
                e && (e._timed = g.isOneDayEvent(e))
            }
        }
        ,
        ...
        g._get_first_visible_cell = function(t) {
            for (var e = 0; e < t.length; e++)
                if (-1 == (t[e].className || "").indexOf("dhx_scale_ignore"))
                    return t[e];
            return t[0]
        }
        ,
        g._pre_render_events = function(t, e) {
            ...
            if (t = this._table_view ? this._pre_render_events_table(t, e) : this._pre_render_events_line(t, e),
            this._table_view)
                if (e)
                    this._colsS.heights = n;
                else {
                    var s = r.firstChild;
                    if (s.rows) {
                        ...
                        s.parentNode.offsetHeight < s.parentNode.scrollHeight && !g._colsS.scroll_fix && g.xy.scroll_width) {
                            ...
                            g._render_month_scale(this._els.dhx_cal_data[0], this._get_timeunit_start(), this._min_date),
                            c.scroll_fix = !0
                        }
                    } else if (t.length || "visible" != this._els.dhx_multi_day[0].style.visibility || (a[0] = -1),
                    t.length || -1 == a[0]) {
                        var v = (s.parentNode.childNodes,
                        (a[0] + 1) * i + 1)
                          , m = v
                          , p = v + "px";
                        this.config.multi_day_height_limit && (m = Math.min(v, this.config.multi_day_height_limit),
                        p = m + "px"),
            ...
            for (var a = 0; a < t.length; a++) {
                ...
                this._ignores[r._sday])
                    ...
                    !e) {
                        ...
                        if (_.length && (_[_.length - 1]._inner = !0),
                        !f)
                            if (_.length)
                        ...
                        _.length > (_.max_count || 0) ? (_.max_count = _.length,
                        r._count = _.length) : r._count = r._count ? r._count : 1
                    }
                    (d < this.config.first_hour || l >= this.config.last_hour) && (n.push(r),
                    t[a] = r = this._copy_event(r),
                    d < this.config.first_hour && (r.start_date.setHours(this.config.first_hour),
                    r.start_date.setMinutes(0)),
                    l >= this.config.last_hour && (r.end_date.setMinutes(0),
                    r.end_date.setHours(this.config.last_hour)),
                    r.start_date > r.end_date || d == this.config.last_hour) && (t.splice(a, 1),
                    a--)
                }
            }
            if (!e) {
        ...
        g._is_any_multiday_cell_visible = function(t, e, i) {
            var n = this._cols.length
              ...
              , s = !0
              , o = new Date(e);
            for (g.date.day_start(new Date(e)).valueOf() != e.valueOf() && (o = g.date.day_start(o),
            o = g.date.add(o, 1, "day")); r < o; ) {
                s = !1;
        ...
        g._pre_render_events_table = function(t, e) {
            ...
            for (var i, n = [], a = [[], [], [], [], [], [], []], r = this._colsS.heights, s = this._cols.length, o = {}, d = 0; d < t.length; d++) {
                ...
                var h = o[_]
                  , c = i || l.start_date
                  , u = l.end_date;
                c < this._min_date && (h.first_chunk = !1,
                c = this._min_date),
                u > this._max_date && (h.last_chunk = !1,
                u = this._max_date);
                var f = this.locate_holder_day(c, !1, l);
                if (l._sday = f % s,
                !this._ignores[l._sday] || !l._timed) {
                    var v = this.locate_holder_day(u, !0, l) || s;
                    l._eday = v % s || s,
                    l._length = v - f,
                    l._sweek = Math.floor((this._correct_shift(c.valueOf(), 1) - this._min_date.valueOf()) / (864e5 * s));
                    if (g._is_any_multiday_cell_visible(c, u, l)) {
                        var m, p = a[l._sweek];
                        for (m = 0; m < p.length && !(p[m]._eday <= l._sday); m++)
                            ;
                        if (l._sorder && e || (l._sorder = m),
                        l._sday + l._length <= s)
                            i = null,
                            n.push(l),
                            p[m] = l,
        ...
        g._copy_event = function(t) {
            return this._copy_dummy.prototype = t,
        ...
        g.updateEvent = function(t) {
            ...
            this.clear_event(t),
            e && this.is_visible_events(e) && this.filter_event(t, e) && (this._table_view || this.config.multi_day || e._timed) && (this.config.update_render ? this.render_view_data() : "month" != this.getState().mode || this.getState().drag_id || this.isOneDayEvent(e) ? this.render_view_data([e], !0) : this.render_view_data())
        }
        ,
        g.clear_event = function(t) {
            this.for_rendered(t, function(t, e) {
                t.parentNode && t.parentNode.removeChild(t),
                g._rendered.splice(e, 1)
            })
        }
        ,
        ...
        g.render_event = function(t, e, i) {
            ...
            if (!(t._sday < 0)) {
                ...
                if (r) {
                    ...
                    e.appendChild(m);
                    if (c = c + parseInt(this.config.rtl ? r.style.right : r.style.left, 10) + a,
                    this._edit_id == t.id) {
                        m.style.zIndex = 1,
                        ...
                        this._editor.onkeydown = function(t) {
                            ...
                            e != g.keys.edit_save && e != g.keys.edit_cancel || t.preventDefault && t.preventDefault()
                        }
                        ,
                        this._editor.onselectstart = function(t) {
                            return (t || event).cancelBubble = !0,
                            !0
                        }
                        ,
        ...
        g._render_v_bar = function(t, e, i, n, a, r, s, o, d) {
            ...
            if (!d && g.renderEvent(A, t, n, a, s, o))
                return A;
            A = l.firstChild;
            var k = '<div class="dhx_event_move dhx_header" style=" width:' + b + "px;" + f + '" >&nbsp;</div>';
            k += '<div class="dhx_event_move dhx_title" style="' + f + v + '">' + s + "</div>",
            k += '<div class="dhx_body" style=" width:' + y + "px; height:" + D + "px;" + f + v + '">' + o + "</div>";
            var S = "dhx_event_resize dhx_footer";
            return (d || !1 === t._drag_resize) && (S = "dhx_resize_denied " + S),
            k += '<div class="' + S + '" style=" width:' + w + "px;" + (d ? " margin-top:-1px;" : "") + f + v + '" ></div>',
            A.innerHTML = k,
            A
        }
        ,
        ...
        g.locate_holder_day = function(t, e) {
            ...
            return e && this.date.time_part(t) && i++,
            i
        }
        ,
        ...
        g._get_event_bar_pos = function(t) {
            var e = this.config.rtl
              ...
              , n = i[t._sday]
              , a = i[t._eday];
            e && (n = i[i.col_length] - i[t._eday] + i[0],
            a = i[i.col_length] - i[t._sday] + i[0]),
            a == n && (a = i[t._eday + 1]);
        ...
        ,
        g.edit = function(t) {
            this._edit_id != t && (this.editStop(!1, t),
            this._edit_id = t,
            this.updateEvent(t))
        }
        ,
        ...
        g.showEvent = function(t, e) {
            var i = "number" == typeof t || "string" == typeof t ? g.getEvent(t) : t;
            if (e = e || g._mode,
            i && (!this.checkEvent("onBeforeEventDisplay") || this.callEvent("onBeforeEventDisplay", [i, e]))) {
                var n = g.config.scroll_hour;
                g.config.scroll_hour = i.start_date.getHours();
                var a = g.config.preserve_scroll;
                g.config.preserve_scroll = !1;
                var r = i.color
                  , s = i.textColor;
                if (g.config.highlight_displayed_event && (i.color = g.config.displayed_event_color,
                i.textColor = g.config.displayed_event_text_color),
                g.setCurrentView(new Date(i.start_date), e),
                i.color = r,
                i.textColor = s,
                g.config.scroll_hour = n,
                g.config.preserve_scroll = a,
                g.matrix && g.matrix[e]) {
                    var o = g.getView()
                      , d = o.y_property
                      , l = g.getEvent(i.id);
                    if (l) {
                        var _ = o.posFromSection(l[d])
                          , h = o.posFromDate(l.start_date)
                          , c = g.$container.querySelector(".dhx_timeline_data_wrapper");
                        h -= (c.offsetWidth - o.dx) / 2,
                        _ = _ - c.offsetHeight / 2 + o.dy / 2,
                        o.scrollTo({
                            left: h,
                            top: _
                        })
                ...
                g.callEvent("onAfterEventDisplay", [i, e])
            }
        }
        ,
        ...
        g.highlightEventPosition = function(t) {
            ...
            this._rendered.push(e),
            this._update_marker_position(e, t);
        ...
        g._load = function(t, e) {
            ...
            if (t = t || this._load_url) {
                ...
                this._load_mode) {
                    ...
                    do {
                        n = s,
                        s = this.date.add(n, -1, this._load_mode)
                    } while (s > e && this._loaded[a(s)]);if (n <= e)
                        return !1;
        ...
        g._parsers.xml = {
            ...
            parse: function(t) {
                var e;
                if (t.xmlDoc.responseXML || (t.xmlDoc.responseXML = g.$ajax.parse(t.xmlDoc.responseText)),
                e = g.$ajax.xmltop("data", t.xmlDoc),
                "data" != e.tagName)
                    return null;
                var i = e.getAttribute("dhx_security");
                i && (window.dhtmlx && (dhtmlx.security_key = i),
                g.security_key = i);
        ...
        g.json = g._parsers.json = {
            ...
            parse: function(t) {
                ...
                e = e || [],
                t.dhx_security && (window.dhtmlx && (dhtmlx.security_key = t.dhx_security),
        ...
        g.ical = g._parsers.ical = {
            ...
            parse_param: function(t, e) {
                ...
                if (-1 != i) {
                    ...
                    "summary" == n ? n = "text" : "dtstart" == n ? (n = "start_date",
                    a = this.parse_date(a, 0, 0)) : "dtend" == n && (n = "end_date",
        ...
        g.on_load = function(t) {
            ...
            if (!n)
                if (this._process && this[this._process])
                    ...
                    i = !0;
            (i || t.xmlDoc.status && t.xmlDoc.status >= 400) && (this.callEvent("onLoadError", [t.xmlDoc]),
            e = []),
        ...
        g.serverList = function(t, e) {
            return e ? (this.serverList[t] = e.slice(0),
        ...
        g._xmlNodeToJSON = function(t) {
            ...
            return e.text || (e.text = t.firstChild ? t.firstChild.nodeValue : ""),
            e
        }
        ,
        ...
        g.attachEvent("onXLE", function() {
            ...
            t && "object" == typeof t && (t.parentNode && t.parentNode.removeChild(t),
        ...
        g.form_blocks = {
            ...
            select: {
                ...
                set_value: function(t, e, i, n) {
                    var a = t.firstChild;
                    !a._dhx_onchange && n.onchange && (a.onchange = n.onchange,
                    a._dhx_onchange = !0),
            ...
            time: {
                render: function(t) {
                    t.time_format || (t.time_format = ["%H:%i", "%d", "%m", "%Y"]),
                    ...
                    var e = t.time_format
                      ...
                      , a = 1440
                      , r = 0;
                    g.config.limit_time_select && (a = 60 * i.last_hour + 1,
                    r = 60 * i.first_hour,
                    n.setHours(i.first_hour));
                    for (var s = "", o = 0; o < e.length; o++) {
                        ...
                        case "%Y":
                            ...
                            t._time_format_order[3] = o;
                            var h, c, u;
                            t.year_range && (isNaN(t.year_range) ? t.year_range.push && (c = t.year_range[0],
                            u = t.year_range[1]) : h = t.year_range),
                            h = h || 10;
                            ...
                            break;
                        case "%m":
                            l = "dhx_lightbox_month_select",
                            t._time_format_order[2] = o;
                            for (var v = 0; v < 12; v++)
                                _ += "<option value='" + v + "'>" + this.locale.date.month_full[v] + "</option>";
                            break;
                        case "%d":
                            l = "dhx_lightbox_day_select",
                            t._time_format_order[1] = o;
                            for (var v = 1; v < 32; v++)
                                _ += "<option value='" + v + "'>" + v + "</option>";
                            break;
                        case "%H:%i":
                            l = "dhx_lightbox_time_select",
                            t._time_format_order[0] = o;
                            var v = r
                              , m = n.getDate();
                            for (t._time_values = []; v < a; ) {
                                _ += "<option value='" + v + "'>" + this.templates.time_picker(n) + "</option>",
                ...
                set_value: function(t, e, i, n) {
                    ...
                    if (o.full_day) {
                        ...
                        h.checked = 0 === g.date.time_part(i.start_date) && 0 === g.date.time_part(i.end_date),
                        ...
                        h.onclick = function() {
                            if (h.checked) {
                                ...
                                (+s == +r || +s >= +r && (0 !== i.end_date.getHours() || 0 !== i.end_date.getMinutes())) && (s = g.date.add(s, 1, "day"))
                            } else
                                r = null,
                                s = null;
                            d[l[0]].disabled = h.checked,
                    ...
                    if (o.auto_end_date && o.event_duration)
                        for (var c = function() {
                            r = new Date(d[l[3]].value,d[l[2]].value,d[l[1]].value,0,d[l[0]].value),
                ...
                get_value: function(t, e, i) {
                    ...
                    e.end_date = new Date(n[a[3] + 4].value,n[a[2] + 4].value,n[a[1] + 4].value,0,n[a[0] + 4].value),
                    !n[a[3]].value || !n[a[3] + 4].value) {
                        var r = g.getEvent(g._lightbox_id);
                        r && (e.start_date = r.start_date,
        ...
        g.showCover = function(t) {
            ...
            this._setLbPosition(t)),
            g.config.responsive_lightbox && (document.documentElement.classList.add("dhx_cal_overflow_container"),
        ...
        g._fill_lightbox = function(t, e) {
            ...
            for (var d = this.config.lightbox.sections, l = 0; l < d.length; l++) {
                ...
                c.set_value.call(this, h, u, i, _),
                d[l].focus && c.focus.call(this, h)
            }
            g._lightbox_id = t
        }
        ,
        ...
        g.hideCover = function(t) {
            ...
            this.hide_cover(),
            g.config.responsive_lightbox && (document.documentElement.classList.remove("dhx_cal_overflow_container"),
        ...
        g.save_lightbox = function() {
            ...
            this.checkEvent("onEventSave") && !this.callEvent("onEventSave", [this._lightbox_id, t, this._new_event]) || (this._empty_lightbox(t),
            this.hide_lightbox())
        }
        ,
                ...
                !(e && e.className && g._getClassName(e).indexOf("dhx_btn_set") > -1) || (e = e.querySelector("[dhx_button]"))) {
                    ...
                    if (e && i)
                        ...
                        case "dhx_cancel_btn":
                            ...
                            break;
                        default:
                            if (e.getAttribute("dhx_button"))
                                g.callEvent("onLightboxButton", [i, e, t]);
                            else {
                                var a, r, s;
                                -1 != i.indexOf("dhx_custom_button") && (-1 != i.indexOf("dhx_custom_button_") ? (a = e.parentNode.getAttribute("index"),
                                s = e.parentNode.parentNode) : (a = e.getAttribute("index"),
                                s = e.parentNode,
                                e = e.firstChild)),
                                a && (r = g.form_blocks[g.config.lightbox.sections[a].type],
        ...
        g.getLightbox = function() {
            if (!this._lightbox) {
                ...
                e += "</div>",
                t.innerHTML = e,
                g.config.drag_lightbox && (t.firstChild.onmousedown = g._ready_to_dnd,
                ...
                for (var a = 0; a < s.length; a++) {
                    ...
                    if (o) {
                        ...
                        e += "<div id='" + s[a].id + "' class='dhx_cal_lsection'>" + d + "<label>" + l + "</label></div>" + o.render.call(this, s[a]),
                        e += "</div>"
                    }
                }
        ...
        g._lightbox_template = "<div class='dhx_cal_ltitle'><span class='dhx_mark'>&nbsp;</span><span class='dhx_time'></span><span class='dhx_title'></span></div><div class='dhx_cal_larea'></div>",
        ...
        g._touch_events = function(t, e, i) {
            ...
            function a(t, e, i, n) {
                ...
                if (g.matrix && g.matrix[g.getState().mode]) {
                    if (g.matrix[g.getState().mode].scrollable)
                        return !1
                }
                var r = Math.abs(t.pageY - e.pageY)
                  , s = Math.abs(t.pageX - e.pageX);
                return r < n && s > i && (!r || s / r > 3) && (t.pageX > e.pageX ? g._click.dhx_cal_next_button() : g._click.dhx_cal_prev_button(),
                !0)
            }
            function r(t) {
                if (!i(t)) {
            ...
            function s(t) {
                i(t) || (g._hide_global_tip(),
                _ && (g._on_mouse_up(e(t || event)),
                g._temp_touch_block = !1),
                g._drag_id = null,
                g._drag_mode = null,
                g._drag_pos = null,
            ...
            var o, d, l, _, h, c, u = (-1 != navigator.userAgent.indexOf("Android") && navigator.userAgent.indexOf("WebKit"),
            0);
            n(document.body, t[0], function(t) {
                if (!i(t)) {
                    ...
                    if (n) {
                        ...
                        if (d = e(t),
                        c)
                            return d ? void ((o.target != d.target || Math.abs(o.pageX - d.pageX) > 5 || Math.abs(o.pageY - d.pageY) > 5) && (h = !0,
                            clearTimeout(l))) : void (h = !0)
                    }
                }
            }),
            ...
            n(this._els.dhx_cal_data[0], "contextmenu", function(t) {
                if (!i(t))
                    return c ? (t && t.preventDefault && t.preventDefault(),
            ...
            n(this._obj, t[1], function(t) {
                if (!i(t)) {
                    ...
                    var a = new Date;
                    if (!h && !_ && a - u < 250)
                        return g._click.dhx_cal_data(n),
                        window.setTimeout(function() {
                            n.type = "dblclick",
                            g._on_dbl_click(n)
                        }, 50),
                    ...
                    !h && !_ && g.config.touch_drag) {
                        ...
                        l = setTimeout(function() {
                            ...
                            g._drag_mode && "create" != g._drag_mode && g.for_rendered(g._drag_id, function(t, e) {
                                t.style.display = "none",
                                g._rendered.splice(e, 1)
                            }),
            ...
            n(this._els.dhx_cal_data[0], t[2], function(t) {
                if (!i(t))
                    return g.config.touch_swipe_dates && !_ && a(o, d, 200, 100) && (g._block_next_stop = !0),
                    _ && (g._ignore_next_click = !0,
                    setTimeout(function() {
                        g._ignore_next_click = !1
                    }, 100)),
                    s(t),
                    g._block_next_stop ? (g._block_next_stop = !1,
                    t.preventDefault && t.preventDefault(),
                    t.cancelBubble = !0,
                    !1) : void 0
            }),
        ...
        g._show_global_tip = function() {
            ...
            t.className = "dhx_global_tip",
            g._update_global_tip(1),
            document.body.appendChild(t)
        }
        ,
        ...
        g._dp_init = function(t) {
            ...
            this._dp_hook_delete = function(e, i) {
                if (g.getEvent(e))
                    return i && e != i && ("true_deleted" == this.getUserData(e, t.action_param) && this.setUserData(e, t.action_param, "updated"),
            ...
            this.attachEvent("onConfirmedBeforeEventDelete", function(e) {
                if (this._validId(e)) {
                    var i = t.getState(e);
                    return "inserted" == i || this._new_event ? (t.setUpdated(e, !1),
                    !0) : "deleted" != i && ("true_deleted" == i || (t.setUpdated(e, !0, "deleted"),
                    !1))
                }
            }),
            ...
            t.attachEvent("deleteCallback", function(t, e) {
                this.obj.getEvent(e) ? (this.obj.setUserData(e, this.action_param, "true_deleted"),
                this.obj.deleteEvent(e)) : this.obj._add_rec_marker && this.obj._update_callback(t, e)
            })
        }
        ,
        ...
        g._skin_init = function() {
            ...
            var n = 0;
            if (!g.skin || "classic" !== g.skin && "glossy" !== g.skin || (n = 1),
            g._is_material_skin()) {
                ...
                if (a && g.config.buttons_left.slice().join() == a && r && g.config.buttons_right.slice().join() == r) {
                    ...
                    g.config.buttons_left = g.config.buttons_right.slice(),
                    g.config.buttons_right = s
                }
            ...
            if (this._configure(g.config, g._skin_settings, n),
            this._configure(g.xy, g._skin_xy, n),
            "flat" === g.skin && (g.xy.scale_height = 35,
            ...
            !n) {
                ...
                g.attachEvent("onTemplatesReady", function() {
                    ...
                    if (g.templates.month_day = function(i) {
                        if ("month" == this._mode) {
                            var n = t(i);
                            return 1 == i.getDate() && (n = g.locale.date.month_full[i.getMonth()] + " " + n),
                            +i == +g.date.date_part(this._currentDate()) && (n = g.locale.labels.dhx_cal_today_button + " " + n),
                            n
                        }
                    ...
                    g.config.fix_tab_position) {
                        var i = g._els.dhx_cal_navline[0].getElementsByTagName("div")
                          ...
                          , r = [14, 75, 136]
                          , s = 14;
                        g._is_material_skin() && (r = [16, 103, 192],
                        a = 294,
                        s = -1);
                        for (var o = 0; o < i.length; o++) {
                            ...
                            if (l) {
                                ...
                                0 === (d.className || "").indexOf("dhx_minical_icon") && d.parentNode == g._els.dhx_cal_navline[0] && (n = d)
                        }
                        n && (n.style.left = a + "px")
                    }
                }),
        ...
        function() {
            ...
            g.attachEvent("onSchedulerReady", function() {
                g.config.delay_render ? (g.setCurrentView = r,
                g.updateView = s) : (g.setCurrentView = e,
                g.updateView = i)
            })
        }();
        for (var S = 0; S < Scheduler._schedulerPlugins.length; S++)
            Scheduler._schedulerPlugins[S](g);
        return g._internal_id = Scheduler._seed++,
        Scheduler.$syncFactory && Scheduler.$syncFactory(g),
        g
    }
    ,
    ...
    dhtmlx && dhtmlx.attaches && (dhtmlx.attaches.attachScheduler = function(t, e, i, n) {
        ...
        a.innerHTML = '<div id="' + a.id + '" class="dhx_cal_container" style="width:100%; height:100%;"><div class="dhx_cal_navline"><div class="dhx_cal_prev_button">&nbsp;</div><div class="dhx_cal_next_button">&nbsp;</div><div class="dhx_cal_today_button"></div><div class="dhx_cal_date"></div>' + i + '</div><div class="dhx_cal_header"></div><div class="dhx_cal_data"></div></div>',
...
Scheduler.plugin(function(e) {
    ...
    e.form_blocks.recurring = {
        ...
        render: function(t) {
            ...
            return (
                '<div class="dhx_form_repeat"> <form> <div class="dhx_repeat_left"> <label><input class="dhx_repeat_radio" type="radio" name="repeat" value="day" />' +
                r.repeat_radio_day +
                '</label><br /> <label><input class="dhx_repeat_radio" type="radio" name="repeat" value="week"/>' +
                r.repeat_radio_week +
                '</label><br /> <label><input class="dhx_repeat_radio" type="radio" name="repeat" value="month" checked />' +
                r.repeat_radio_month +
                '</label><br /> <label><input class="dhx_repeat_radio" type="radio" name="repeat" value="year" />' +
                r.repeat_radio_year +
                '</label> </div> <div class="dhx_repeat_divider"></div> <div class="dhx_repeat_center"> <div style="display:none;" id="dhx_repeat_day"> <label><input class="dhx_repeat_radio" type="radio" name="day_type" value="d"/>' +
                r.repeat_radio_day_type +
                '</label><label><input class="dhx_repeat_text" type="text" name="day_count" value="1" />' +
                r.repeat_text_day_count +
                '</label><br /> <label><input class="dhx_repeat_radio" type="radio" name="day_type" checked value="w"/>' +
                r.repeat_radio_day_type2 +
                '</label> </div> <div style="display:none;" id="dhx_repeat_week"><label>' +
                r.repeat_week +
                '<input class="dhx_repeat_text" type="text" name="week_count" value="1" /></label><span>' +
                r.repeat_text_week_count +
                '</span><br /> <table class="dhx_repeat_days"> <tr> <td> <label><input class="dhx_repeat_checkbox" type="checkbox" name="week_day" value="1" />' +
                r.day_for_recurring[1] +
                '</label><br /> <label><input class="dhx_repeat_checkbox" type="checkbox" name="week_day" value="4" />' +
                r.day_for_recurring[4] +
                '</label> </td> <td> <label><input class="dhx_repeat_checkbox" type="checkbox" name="week_day" value="2" />' +
                r.day_for_recurring[2] +
                '</label><br /> <label><input class="dhx_repeat_checkbox" type="checkbox" name="week_day" value="5" />' +
                r.day_for_recurring[5] +
                '</label> </td> <td> <label><input class="dhx_repeat_checkbox" type="checkbox" name="week_day" value="3" />' +
                r.day_for_recurring[3] +
                '</label><br /> <label><input class="dhx_repeat_checkbox" type="checkbox" name="week_day" value="6" />' +
                r.day_for_recurring[6] +
                '</label> </td> <td> <label><input class="dhx_repeat_checkbox" type="checkbox" name="week_day" value="0" />' +
                r.day_for_recurring[0] +
                '</label><br /><br /> </td> </tr> </table> </div> <div id="dhx_repeat_month"> <label class = "dhx_repeat_month_label"><input class="dhx_repeat_radio" type="radio" name="month_type" value="d"/>' +
                r.repeat_radio_month_type +
                '</label><label><input class="dhx_repeat_text" type="text" name="month_day" value="1" />' +
                r.repeat_text_month_day +
                '</label><label><input class="dhx_repeat_text" type="text" name="month_count" value="1" />' +
                r.repeat_text_month_count +
                '</label><br /> <label class = "dhx_repeat_month_label"><input class="dhx_repeat_radio" type="radio" name="month_type" checked value="w"/>' +
                r.repeat_radio_month_start +
                '</label><input class="dhx_repeat_text" type="text" name="month_week2" value="1" /><label><select name="month_day2">\t<option value="1" selected >' +
                e.locale.date.day_full[1] +
                '<option value="2">' +
                e.locale.date.day_full[2] +
                '<option value="3">' +
                e.locale.date.day_full[3] +
                '<option value="4">' +
                e.locale.date.day_full[4] +
                '<option value="5">' +
                e.locale.date.day_full[5] +
                '<option value="6">' +
                e.locale.date.day_full[6] +
                '<option value="0">' +
                e.locale.date.day_full[0] +
                "</select>" +
                r.repeat_text_month_count2_before +
                '</label><label><input class="dhx_repeat_text" type="text" name="month_count2" value="1" />' +
                r.repeat_text_month_count2_after +
                '</label><br /> </div> <div style="display:none;" id="dhx_repeat_year"> <label class = "dhx_repeat_year_label"><input class="dhx_repeat_radio" type="radio" name="year_type" value="d"/>' +
                r.repeat_radio_day_type +
                '</label><label><input class="dhx_repeat_text" type="text" name="year_day" value="1" />' +
                r.repeat_text_year_day +
                '</label><label><select name="year_month"><option value="0" selected >' +
                r.month_for_recurring[0] +
                '<option value="1">' +
                r.month_for_recurring[1] +
                '<option value="2">' +
                r.month_for_recurring[2] +
                '<option value="3">' +
                r.month_for_recurring[3] +
                '<option value="4">' +
                r.month_for_recurring[4] +
                '<option value="5">' +
                r.month_for_recurring[5] +
                '<option value="6">' +
                r.month_for_recurring[6] +
                '<option value="7">' +
                r.month_for_recurring[7] +
                '<option value="8">' +
                r.month_for_recurring[8] +
                '<option value="9">' +
                r.month_for_recurring[9] +
                '<option value="10">' +
                r.month_for_recurring[10] +
                '<option value="11">' +
                r.month_for_recurring[11] +
                "</select>" +
                r.select_year_month +
                '</label><br /> <label class = "dhx_repeat_year_label"><input class="dhx_repeat_radio" type="radio" name="year_type" checked value="w"/>' +
                r.repeat_year_label +
                '</label><input class="dhx_repeat_text" type="text" name="year_week2" value="1" /><select name="year_day2"><option value="1" selected >' +
                e.locale.date.day_full[1] +
                '<option value="2">' +
                e.locale.date.day_full[2] +
                '<option value="3">' +
                ...
                "</select>" +
                r.select_year_day2 +
                '<select name="year_month2"><option value="0" selected >' +
                r.month_for_recurring[0] +
                '<option value="1">' +
                r.month_for_recurring[1] +
                '<option value="2">' +
                ...
                '<option value="11">' +
                r.month_for_recurring[11] +
                '</select><br /> </div> </div> <div class="dhx_repeat_divider"></div> <div class="dhx_repeat_right"> <label><input class="dhx_repeat_radio" type="radio" name="end" checked/>' +
                r.repeat_radio_end +
                '</label><br /> <label><input class="dhx_repeat_radio" type="radio" name="end" />' +
                r.repeat_radio_end2 +
                '</label><input class="dhx_repeat_text" type="text" name="occurences_count" value="1" />' +
                r.repeat_text_occurences_count +
                '<br /> <label><input class="dhx_repeat_radio" type="radio" name="end" />' +
                r.repeat_radio_end3 +
                '</label><input class="dhx_repeat_date" type="text" name="date_of_end" value="' +
                e.config.repeat_date_of_end +
        ...
        _get_node_numeric_value: function(t, a) {
            return 1 * e.form_blocks.recurring._get_node_value(t, a) || 0
        },
        ...
        _init_set_value: function(t, a, n) {
            ...
            function r() {
                y("dhx_repeat_day").style.display = "none",
                y("dhx_repeat_week").style.display = "none",
                y("dhx_repeat_month").style.display = "none",
                y("dhx_repeat_year").style.display = "none",
                y("dhx_repeat_" + this.value).style.display = "block",
                e.setLightboxSize()
            }
            function o(t) {
                var a = [c(p, "repeat")];
                for (b[a[0]](a, t); a.length < 5; )
                    a.push("");
                var n = ""
                  , i = _(p);
                if ("no" == i)
                    ...
                    t.end = g(c(p, "date_of_end"));
                else {
                    e.transpose_type(a.join("_")),
                    n = Math.max(1, c(p, "occurences_count"));
                    var r = 0;
            ...
            function d(e, t) {
                var a = e.end;
                if (a.length) {
                    if (!!a[0].value && "on" != a[0].value)
                        for (var n = 0; n < a.length; n++)
                            a[n].value == t && (a[n].checked = !0);
                    else {
                        var i = 0;
                        switch (t) {
                        case "no":
            ...
            function s(t, a) {
                ...
                case "":
                    ...
                    break;
                default:
                    d(p, "occurences_count"),
                    n(p, "occurences_count", i[1])
                }
                n(p, "repeat", t[0]);
                var o = e.form_blocks.recurring._get_form_node(p, "repeat", t[0]);
            ...
            var u = e.date.str_to_date(e.config.repeat_date)
              , g = function(t) {
                var a = u(t);
                return e.config.include_end_by && (a = e.date.add(a, 1, "day")),
                a
            }
              , f = e.date.date_to_str(e.config.repeat_date)
              , v = t.getElementsByTagName("FORM")[0]
              , p = {};
            if (i(v.getElementsByTagName("INPUT")),
            i(v.getElementsByTagName("SELECT")),
            !e.config.repeat_date_of_end) {
                var m = e.date.date_to_str(e.config.repeat_date);
                e.config.repeat_date_of_end = m(e.date.add(e._currentDate(), 30, "day"))
            }
            h(p, "date_of_end", e.config.repeat_date_of_end);
            var y = function(e) {
            ...
            var b = {
                month: function(t, a) {
                    ...
                    "d" == n(p, "month_type") ? (t.push(Math.max(1, i(p, "month_count"))),
                    a.start.setDate(n(p, "month_day"))) : (t.push(Math.max(1, i(p, "month_count2"))),
                    t.push(n(p, "month_day2")),
                    t.push(Math.max(1, i(p, "month_week2"))),
                    e.config.repeat_precise || a.start.setDate(1)),
                    a._start = !0
                },
                week: function(t, a) {
                    var n = e.form_blocks.recurring._get_node_value
                      , i = e.form_blocks.recurring._get_node_numeric_value;
                    t.push(Math.max(1, i(p, "week_count"))),
                    t.push(""),
                    t.push("");
                    for (var r = [], o = n(p, "week_day", !0), _ = a.start.getDay(), d = !1, s = 0; s < o.length; s++)
                        r.push(o[s]),
                        d = d || o[s] == _;
                    r.length || (r.push(_),
                    d = !0),
                    r.sort(),
                    e.config.repeat_precise ? d || (e.transpose_day_week(a.start, r, 1, 7),
                    a._start = !0) : (a.start = e.date.week_start(a.start),
                    a._start = !0),
                    t.push(r.join(","))
                },
                day: function(t) {
                    ...
                    "d" == a(p, "day_type") ? t.push(Math.max(1, n(p, "day_count"))) : (t.push("week"),
                    t.push(1),
                    t.push(""),
                    t.push(""),
                    t.push(e.config.recurring_workdays.join(",")),
                    t.splice(0, 1))
                },
                year: function(t, a) {
                    var n = e.form_blocks.recurring._get_node_value;
                    "d" == n(p, "year_type") ? (t.push("1"),
                    a.start.setMonth(0),
                    a.start.setDate(n(p, "year_day")),
                    a.start.setMonth(n(p, "year_month"))) : (t.push("1"),
                    t.push(n(p, "year_day2")),
                    t.push(n(p, "year_week2")),
                    a.start.setDate(1),
                    a.start.setMonth(n(p, "year_month2"))),
                    a._start = !0
                }
            }
              , x = {
                ...
                month: function(t, a) {
                    var n = e.form_blocks.recurring._set_node_value;
                    "" === t[2] ? (n(p, "month_type", "d"),
                    n(p, "month_count", t[1]),
                    n(p, "month_day", a.start.getDate())) : (n(p, "month_type", "w"),
                    n(p, "month_count2", t[1]),
                    n(p, "month_week2", t[3]),
                    n(p, "month_day2", t[2]))
                },
                day: function(t, a) {
                ...
                year: function(t, a) {
                    var n = e.form_blocks.recurring._set_node_value;
                    "" === t[2] ? (n(p, "year_type", "d"),
                    n(p, "year_day", a.start.getDate()),
                    n(p, "year_month", a.start.getMonth())) : (n(p, "year_type", "w"),
                    n(p, "year_week2", t[3]),
                    n(p, "year_day2", t[2]),
                    n(p, "year_month2", a.start.getMonth()))
                }
            };
            e.form_blocks.recurring._set_repeat_code = s;
            for (var w = 0; w < v.elements.length; w++) {
                var k = v.elements[w];
                switch (k.name) {
                case "repeat":
                    "SELECT" == k.nodeName ? k.onchange = r : k.onclick = r
                }
            }
        ...
        get_value: function(t, a) {
            if (t.open) {
                ...
                n._start ? (a.start_date = new Date(n.start),
                a._start_date = new Date(n.start),
                n._start = !1) : a._start_date = null,
                a._end_date = n.end,
        ...
        _get_button: function() {
            return e.formSection("recurring").header.firstChild.firstChild
        },
        _get_form: function() {
        ...
        open: function() {
            ...
            t._get_form().open || t._toggle_block()
        },
        close: function() {
            var t = e.form_blocks.recurring;
            t._get_form().open && t._toggle_block()
        ...
        _toggle_block: function() {
            var t = e.form_blocks.recurring
              , a = t._get_form()
              , n = t._get_button();
            a.open || a.blocked ? (a.style.height = "0px",
            n && (n.style.backgroundPosition = "-5px 20px",
            n.nextSibling.innerHTML = e.locale.labels.button_recurring)) : (a.style.height = "auto",
            n && (n.style.backgroundPosition = "-5px 0px",
            n.nextSibling.innerHTML = e.locale.labels.button_recurring_open)),
            a.open = !a.open,
            e.setLightboxSize()
        },
        focus: function(e) {},
    ...
    function() {
        ...
        e.addEvent = function(a, n, i, r, o) {
            var _ = t.apply(this, arguments);
            if (_ && e.getEvent(_)) {
                var d = e.getEvent(_);
                this._is_modified_occurence(d) && e._add_rec_marker(d, 1e3 * d.event_length),
    ...
    e.attachEvent("onEventIdChange", function(t, a) {
        if (!this._ignore_call) {
            this._ignore_call = !0,
            e._rec_markers[t] && (e._rec_markers[a] = e._rec_markers[t],
            delete e._rec_markers[t]),
            e._rec_markers_pull[t] && (e._rec_markers_pull[a] = e._rec_markers_pull[t],
            delete e._rec_markers_pull[t]);
            for (var n = 0; n < this._rec_temp.length; n++) {
                var i = this._rec_temp[n];
                i.event_pid == t && (i.event_pid = a,
                this.changeEventId(i.id, a + "#" + i.id.split("#")[1]))
            }
            ...
            r && r._pid_changed && (delete r._pid_changed,
            setTimeout(function() {
    ...
    e.attachEvent("onConfirmedBeforeEventDelete", function(e) {
        ...
        if (this._is_virtual_event(e) || this._is_modified_occurence(t) && t.rec_type && "none" != t.rec_type) {
            ...
            for (var _ in o)
                o.hasOwnProperty(_) && (e = o[_].id,
                this.getEvent(e) && this.deleteEvent(e, !0))
        }
        return !0
    }),
    e.attachEvent("onEventDeleted", function(t, a) {
        !this._is_virtual_event(t) && this._is_modified_occurence(a) && (e._events[t] || (a.rec_type = a.rec_pattern = "none",
        this.setEvent(t, a)))
    }),
    e.attachEvent("onEventChanged", function(e, t) {
        ...
        if (this._is_virtual_event(e)) {
            ...
            var o = this._get_rec_markers(e);
            for (var _ in o)
                o.hasOwnProperty(_) && (delete this._rec_markers[o[_].id],
                this.deleteEvent(o[_].id, !0));
            delete this._rec_markers_pull[e];
            for (var d = !1, s = 0; s < this._rendered.length; s++)
                this._rendered[s].getAttribute("event_id") == e && (d = !0);
    ...
    e.attachEvent("onEventSave", function(e, t, a) {
        return this.getEvent(e).rec_type || !t.rec_type || this._is_virtual_event(e) || (this._select_id = null),
        !0
    }),
    e.attachEvent("onEventCreated", function(e) {
        var t = this.getEvent(e);
        return t.rec_type || (t.rec_type = t.rec_pattern = t.event_length = t.event_pid = ""),
        !0
    }),
    e.attachEvent("onEventCancel", function(e) {
        var t = this.getEvent(e);
        t.rec_type && (this._roll_back_dates(t),
        this.render_view_data())
    }),
    e._roll_back_dates = function(e) {
        e.event_length = (e.end_date.valueOf() - e.start_date.valueOf()) / 1e3,
        e.end_date = e._end_date,
        e._start_date && (e.start_date.setMonth(0),
        e.start_date.setDate(e._start_date.getDate()),
        e.start_date.setMonth(e._start_date.getMonth()),
    ...
    function() {
        ...
        e.isOneDayEvent = function(e) {
            return !!e.rec_type || t.call(this, e)
        }
        ;
        var a = e.updateEvent;
    ...
    e.transpose_day_week = function(t, a, n, i, r) {
        for (var o = (t.getDay() || (e.config.start_on_monday ? 7 : 0)) - n, _ = 0; _ < a.length; _++)
            if (a[_] > o)
                return t.setDate(t.getDate() + 1 * a[_] - o - (i ? n : r));
    ...
    e.transpose_type = function(t) {
        ...
        if (!this.date[a]) {
            var n = t.split("_")
              , i = "add_" + t
              , r = this.transponse_size[n[0]] * n[1];
            if ("day" == n[0] || "week" == n[0]) {
                var o = null;
                if (n[4] && (o = n[4].split(","),
                e.config.start_on_monday)) {
                    for (var _ = 0; _ < o.length; _++)
                        o[_] = 1 * o[_] || 7;
                    o.sort()
                }
                this.date[a] = function(t, a) {
                    var n = Math.floor((a.valueOf() - t.valueOf()) / (864e5 * r));
                    n > 0 && t.setDate(t.getDate() + n * r),
                    o && e.transpose_day_week(t, o, 1, r)
                }
                ,
                this.date[i] = function(t, a) {
                    var n = new Date(t.valueOf());
                    if (o)
                        for (var i = 0; i < a; i++)
                            e.transpose_day_week(n, o, 0, r);
                    else
                        n.setDate(n.getDate() + a * r);
                    return n
                }
            } else
                "month" != n[0] && "year" != n[0] || (this.date[a] = function(t, a) {
                    var i = Math.ceil((12 * a.getFullYear() + 1 * a.getMonth() + 1 - (12 * t.getFullYear() + 1 * t.getMonth() + 1)) / r - 1);
                    i >= 0 && t.setMonth(t.getMonth() + i * r),
                    n[3] && e.date.day_week(t, n[2], n[3])
                }
                ,
                this.date[i] = function(t, a) {
                    var i = new Date(t.valueOf());
                    return i.setMonth(i.getMonth() + a * r),
                    n[3] && e.date.day_week(i, n[2], n[3]),
                    i
                }
                )
        }
    ...
    e.repeat_date = function(t, a, n, i, r, o) {
        ...
        r = r || this._max_date;
        var _ = o || -1
          , d = new Date(t.start_date.valueOf())
          , s = d.getHours()
          , l = 0;
        for (!t.rec_pattern && t.rec_type && (t.rec_pattern = t.rec_type.split("#")[0]),
        this.transpose_type(t.rec_pattern),
        e.date["transpose_" + t.rec_pattern](d, i); d < t.start_date || e._fix_daylight_saving_date(d, i, t, d, new Date(d.valueOf() + 1e3 * t.event_length)).valueOf() <= i.valueOf() || d.valueOf() + 1e3 * t.event_length <= i.valueOf(); )
            d = this.date.add(d, 1, t.rec_pattern);
        for (; d < r && d < t.end_date && (_ < 0 || l < _); ) {
            d.setHours(s);
            var c = e.config.occurrence_timestamp_in_utc ? Date.UTC(d.getFullYear(), d.getMonth(), d.getDate(), d.getHours(), d.getMinutes(), d.getSeconds()) : d.valueOf()
              , h = this._get_rec_marker(c, t.id);
            if (h)
                n && ("none" != h.rec_type && l++,
                a.push(h));
            else {
                var u = new Date(d.valueOf() + 1e3 * t.event_length)
                  , g = this._copy_event(t);
                if (g.text = t.text,
                g.start_date = d,
                g.event_pid = t.id,
                g.id = t.id + "#" + Math.ceil(c / 1e3),
                g.end_date = u,
                g.end_date = e._fix_daylight_saving_date(g.start_date, g.end_date, t, d, g.end_date),
                g._timed = this.isOneDayEvent(g),
                !g._timed && !this._table_view && !this.config.multi_day)
                    return;
                a.push(g),
                n || (this._events[g.id] = g,
                this._rec_temp.push(g)),
                l++
            }
            d = this.date.add(d, 1, t.rec_pattern)
        }
